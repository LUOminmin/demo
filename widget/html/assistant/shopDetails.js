define(function (require,exports,module) {
	...
	var closeEdit = api.pageParam.closeEdit;
	...
	var vm = new Vue({
		...
		data:{
            ...
            goal_sales_type: 'sales_price',
            goal_sales_text: '已完成营业额'
		},
		created:function () {
       this.rankInfo = {};
		},
						 ...
						 logger.log({"Type":"operation","action":"获取门店目标图表数据","Win_name":api.winName,"data":_data,"message":res,"requireURL":_url})
							if (res.code == 200) {
									setTimeout(function(){
										 ...
										 vm.goal_sales_type = res.object.goal_sales_type;
										 vm.goal_sales_text = goalText(res.object.goal_sales_type);
	...
	if(closeEdit) {
		setTimeout(function(){
			api.closeWin({ name: 'targetShop-editTargetManager-win'});
		}, 1000);
	}
