define(function (require,exports,module) {
    ...
    var initData = function (clerk) {
        if (!clerk) vm.sales_name = '';
        vm.sales_type = '';
        vm.time = '';
    };
	...
	api.addEventListener && api.addEventListener({
        ...
        if (!vm.sales_type_id && vm.sales_type === '全部类型') {
            vm.class_id = null;
            vm.class_level=null;
            vm.brand_id = null;
        }
    ...
    api.addEventListener && api.addEventListener({
        ...
        if (ret.value.isNewKPI) {
            vm.isNewKPI = ret.value.isNewKPI;
        }
    });
