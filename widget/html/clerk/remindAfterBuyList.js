        ...
        methods: {
            ...
            onchooseTag : function(){
                ...
                if(this.chooseTag){
                    ...
                    _.map(this.list, function(item) {
                        item.check =false;
                        vm.rememberCheckProductID.splice(this.rememberCheckProductID.indexOf(this.list[idx].productID), 1);
                        vm.rememberCheckSkuCode.splice(this.rememberCheckSkuCode.indexOf(this.list[idx].skuCode), 1);
                    });
                    this.countNum();
                }
            },
