define(function (require, exports, module) {
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            onDispatchCoupon: function () {
                memberDeatilOpr("选择卡券",type);
                _g.openWin({
                    header: {
                        data: {
                            title: '选择卡券',
                    ...
                    name: 'member-couponDispatch',
                    url: '../member/couponDispatch.html',
                    bounces: false,
                    slidBackEnabled: false,
                });
            },
            onRePurchase: function() {
                memberDeatilOpr("复购提醒",type);
                _g.openWin({
                    header: {
                        data: {
                            title: '复购提醒'
            ...
            onOpenDX: function (type) {
                var Name = type == 1?"短信":(type == 2? "微信":"电话");
                memberDeatilOpr(Name,type);
                if (type == 1) {
                    api.sms({
